...
use Cms;
use Spatie\Analytics\AnalyticsFacade; //use Spatie\LaravelAnalytics\LaravelAnalyticsFacade;
use Spatie\Analytics\AnalyticsServiceProvider; //use Spatie\LaravelAnalytics\LaravelAnalyticsServiceProvider;

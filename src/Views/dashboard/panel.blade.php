<ul class="nav nav-sidebar">
    ...
    @if (in_array('images', Config::get('quarx.activeCoreModules', Quarx::defaultModules())))
    ...
    @if (in_array('files', Config::get('quarx.activeCoreModules', Quarx::defaultModules())))
    ...
    @if (in_array('blog', Config::get('quarx.activeCoreModules', Quarx::defaultModules())))
    ...
    @if (in_array('menus', Config::get('quarx.activeCoreModules', Quarx::defaultModules())))
    ...
    @if (in_array('pages', Config::get('quarx.activeCoreModules', Quarx::defaultModules())))
    ...
    @if (in_array('widgets', Config::get('quarx.activeCoreModules', Quarx::defaultModules())))
    ...
    @if (in_array('faqs', Config::get('quarx.activeCoreModules', Quarx::defaultModules())))
    ...
    @if (in_array('events', Config::get('quarx.activeCoreModules', Quarx::defaultModules())))

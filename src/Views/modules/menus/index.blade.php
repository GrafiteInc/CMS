...
@section('content')
    ...
    <div class="row">
        <a class="btn btn-primary pull-right" href="{!! route(config('cms.backend-route-prefix', 'cms').'.menus.create') !!}">Add New</a>
        <div class="raw-m-hide pull-right">
            {!! Form::open(['url' => 'cms/menus/search']) !!}
                    ...
                    @foreach($menus as $menu)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a class="btn btn-xs btn-default pull-right raw-margin-right-8" href="{!! route(config('cms.backend-route-prefix', 'cms').'.menus.edit', [$menu->id]) !!}"><i class="fa fa-pencil"></i> Edit</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>

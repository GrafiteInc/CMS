...
class FilesTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->withoutEvents();
        factory(\Grafite\Quarx\Models\File::class)->create();
    }
    ...
    */
    ...
    public function testStore()
    {
        ...
        $file = factory(\Grafite\Quarx\Models\File::class)->make([
            'id' => 2,
            'location' => [
                'file_a' => [
    ...
    {
        $file = (array) factory(\Grafite\Quarx\Models\File::class)->make(['id' => 3, 'title' => 'dumber']);

...
class ImagesTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->withoutEvents();
        factory(\Grafite\Quarx\Models\Image::class)->create();
    }
    ...
    */
    ...
    public function testStore()
    {
        ...
        $image = (array) factory(\Grafite\Quarx\Models\Image::class)->make(['id' => 2]);
        $image['location'] = [
            [
    ...
    {
        $image = (array) factory(\Grafite\Quarx\Models\Image::class)->make(['id' => 3, 'title' => 'dumber']);

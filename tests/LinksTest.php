...
class LinksTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->withoutEvents();
        factory(\graphite\Quarx\Models\Link::class)->create();
        factory(\graphite\Quarx\Models\Link::class)->make(['id' => 1]);
    }
    ...
    */
    ...
    {
        $link = factory(\graphite\Quarx\Models\Link::class)->make(['id' => 89]);
